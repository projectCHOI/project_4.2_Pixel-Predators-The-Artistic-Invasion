...
class Stage1Boss:
    def __init__(self):
        ...
        self.boss_image = pygame.transform.scale(
            pygame.image.load(r"C:/Users/boss3/OneDrive/바탕 화면/GitHub/project_4.2_Pixel-Predators-The-Artistic-Invasion/project4.2_mob/Mob_Boss_A.png"), 
            (120, 120)
        )
        ...
        self.gem_image = pygame.transform.scale(
            pygame.image.load(r"C:/Users/boss3/OneDrive/바탕 화면/GitHub/project_4.2_Pixel-Predators-The-Artistic-Invasion/project4.2_mob/mob_Jewelry_1.png"),
            (40, 40)
        )
