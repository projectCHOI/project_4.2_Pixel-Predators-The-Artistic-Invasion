...
class Stage9Boss:
    def __init__(self):
        ...
        self.boss_image = load_image("bosses", "boss_stage9_N.png", size=(180, 180))
        self.minion_image = load_image("bosses", "boss_stage9_S.png", size=(100, 100))
        self.attack_image = load_image("boss_skilles", "boss_stage9_f.png", size=(60, 60))
    ...
    def check_appear(self, seconds, current_level):
        if current_level == 9 and not self.boss_active and seconds >= 10 and not self.boss_appeared:
